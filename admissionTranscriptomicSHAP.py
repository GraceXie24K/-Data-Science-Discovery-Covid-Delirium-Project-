...
# Select models for SHAP analysis: XGBoost, Gradient Boosting, LightGBM, Logistic Regression, Random Forest, SVM
# Include SVM even if it's not in top 5, and get all individual models for SHAP selection
all_individual_models_for_shap = results_df[~results_df['Model'].str.contains('Ensemble')]
shap_models = all_individual_models_for_shap[all_individual_models_for_shap['Model'].isin(['XGBoost', 'Gradient Boosting', 'LightGBM', 'Logistic Regression', 'Random Forest', 'SVM'])]
...
print("- SHAP plots for 6 selected models: XGBoost, Gradient Boosting, LightGBM, Logistic Regression, Random Forest, SVM")
print("- SHAP values CSV files with top features for each model")
print("- Generated SHAP plots for all selected models including Random Forest and SVM")
