...
# Feature importance and SHAP analysis for top 3 individual models
print(f"\n=== FEATURE IMPORTANCE AND SHAP ANALYSIS ===")

# Get top 3 individual models (excluding ensemble models)
individual_models = results_df[~results_df['Model'].str.contains('Ensemble')].head(3)
print(f"Top 3 individual models: {individual_models['Model'].tolist()}")

for rank, (_, model_row) in enumerate(individual_models.iterrows(), 1):
...
print("- SHAP plots for top 3 individual models in graph/ folder")
